...
const mappings = {  
  ...
  "@item-active-bg":"color(~`colorPalette(\"@{primary-color}\", 1)`)",
  "@item-hover-bg":"color(~`colorPalette(\"@{primary-color}\", 1)`)",
  "@link-color":"#1890ff",
  ...
  "@btn-default-color":"fade(#000, 65%)",
  "@btn-default-bg":"#fff",
  "@btn-danger-color":"#f5222d",
  "@btn-disable-color":"fade(#000, 25%)",
  "@btn-group-border":"color(~`colorPalette(\"@{primary-color}\", 5)`)",
  "@checkbox-color":"#1890ff",
  "@checkbox-check-color":"#fff",
  "@radio-dot-color":"#1890ff",
  "@radio-button-bg":"#fff",
  "@radio-button-color":"fade(#000, 65%)",
  "@radio-button-hover-color":"color(~`colorPalette(\"@{primary-color}\", 5)`)",
  "@radio-button-active-color":"color(~`colorPalette(\"@{primary-color}\", 7)`)",
  ...
  "@layout-trigger-color-light":"fade(#000, 65%)",
  "@label-required-color":"#f5222d",
  "@label-color":"fade(#000, 85%)",
  "@input-color":"fade(#000, 65%)",
  "@input-bg":"#fff",
  ...
  "@popover-bg":"#fff",
  "@popover-color":"fade(#000, 65%)",
  "@popover-arrow-color":"#fff",
  "@popover-arrow-outer-color":"#fff",
  "@modal-mask-bg":"rgba(0, 0, 0, 0.65)",
  "@progress-default-color":"#1890ff",
  "@progress-text-color":"fade(#000, 65%)",
  "@menu-bg":"#fff",
  "@menu-item-color":"fade(#000, 65%)",
  "@menu-highlight-color":"#1890ff",
  "@menu-item-active-bg":"color(~`colorPalette(\"@{primary-color}\", 1)`)",
  ...
  "@table-header-color":"fade(#000, 85%)",
  "@table-body-sort-bg":"rgba(0, 0, 0, .01)",
  "@table-row-hover-bg":"color(~`colorPalette(\"@{primary-color}\", 1)`)",
  "@table-selected-row-bg":"#fafafa",
  "@table-expanded-row-bg":"#fbfbfb",
  "@tag-default-color":"fade(#000, 65%)",
  ...
  "@tabs-hover-color":"color(~`colorPalette(\"@{primary-color}\", 5)`)",
  "@tabs-active-color":"color(~`colorPalette(\"@{primary-color}\", 7)`)",
  "@back-top-color":"#fff",
  "@back-top-bg":"fade(#000, 45%)",
  "@back-top-hover-bg":"fade(#000, 65%)",
  "@avatar-bg":"#ccc",
  "@avatar-color":"#fff",
  "@switch-color":"#1890ff",
  "@breadcrumb-base-color":"fade(#000, 45%)",
  "@breadcrumb-last-item-color":"fade(#000, 65%)",
  "@breadcrumb-link-color":"fade(#000, 45%)",
  "@breadcrumb-link-color-hover":"color(~`colorPalette(\"@{primary-color}\", 5)`)",
  "@breadcrumb-separator-color":"fade(#000, 45%)",
  "@slider-rail-background-color-hover":"#e1e1e1",
  "@slider-track-background-color":"color(~`colorPalette(\"@{primary-color}\", 3)`)",
  "@slider-track-background-color-hover":"color(~`colorPalette(\"@{primary-color}\", 4)`)",
  "@slider-handle-color":"color(~`colorPalette(\"@{primary-color}\", 3)`)",
  "@slider-handle-color-hover":"color(~`colorPalette(\"@{primary-color}\", 4)`)",
  "@slider-handle-color-tooltip-open":"#1890ff",
  "@slider-disabled-color":"fade(#000, 25%)",
  ...
  "@menu-dark-item-selected-bg":"#1890ff",
  "@tab-highlight-color":"#1890ff",
  "@tab-hover-color":"color(~`colorPalette(\"@{primary-color}\", 5)`)",
  "@tab-active-color":"color(~`colorPalette(\"@{primary-color}\", 7)`)",
  "@tabs-ink-bar-bg-color":"#1890ff"
};


const validThemes = options.themeVariables.filter(name => name in mappings);
